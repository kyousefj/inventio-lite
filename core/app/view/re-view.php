					...
					<table class="table table-bordered table-hover">
						...
						<?php foreach ($_SESSION["reabastecer"] as $p):
							...
							<tr>
								...
								<td><b>$
										<?php echo number_format($product->price_in); ?>
									</b></td>
								<td><b>$
										<?php $pt = $product->price_in * $p["q"];
										$total += $pt;
										echo number_format($pt); ?>
									</b></td>
								<td style="width:30px;"><a href="index.php?view=clearre&product_id=<?php echo $product->id; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a>
								</td>
							</tr>
						<?php endforeach; ?>
					</table>
							...
							<div class="col-md-6 col-md-offset-6">
								<table class="table table-bordered">
									<tr>
										...
										<td>
											<p><b>$
													<?php echo number_format($total * .84); ?>
												</b></p>
										</td>
									</tr>
									<tr>
										...
										<td>
											<p><b>$
													<?php echo number_format($total * .16); ?>
												</b></p>
										</td>
									</tr>
									<tr>
