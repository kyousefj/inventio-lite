		...
		<div class="col-md-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h1>
						<?php echo $product->name; ?> <small>Historial</small>
					</h1>
				</div>
								...
								<table class="table table-bordered table-hover">
									...
									<?php foreach ($operations as $operation): ?>
										<tr>
											...
											<td>
												<?php echo $operation->getOperationType()->name; ?>
											</td>
											<td>
												<?php echo $operation->created_at; ?>
											</td>
											<td style="width:40px;"><a href="#" id="oper-<?php echo $operation->id; ?>" class="btn tip btn-xs btn-danger" title="Eliminar"><i
